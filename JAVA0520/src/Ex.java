...
public class Ex {
	...
	public static void main(String[] args) {
		 ...
		 *      인터페이스는 상속받아 추상메서들을 구현(implements)의 개념이 강함
		 * 
...
//		MyExInterface mi = new MyExInterface();
		...
		// 인터페이스를 구현한 서브클래스(구현클래스) 인스턴스 생성
...
//		MyExInterface.NUM1 = 99; // 변경 불가!
		// => The final field MyExInterface.NUM1 cannot be assigned
//		MySubClass.NUM1 = 99; // 변경 불가!
//		msc.NUM1 = 99; // 변경 불가!
		
		System.out.println("========================================");
		
		// 인터페이스는 인스턴스 생성이 불가능하지만 참조변수 타입으로 사용가능
		...
		// 상수도 인터페이스에서 선언했으므로 업캐스팅 이후에도 접근 가능
