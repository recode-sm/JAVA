...
public class Ex4 {
	...
	public static void main(String[] args) {
		...
		//관계 연산자와 결합하여 대소 관계에 대한 논리적인 판별확인 가능
		int num = 1;
		...
		System.out.println(num > 5 && num < 10); // false && true = false
		
		//ex) num 이 0보다 작거나 100보다 큰가?
		//    => ~이거나, 또는 등의 의미는 OR연산자 || 사용하여 결합
