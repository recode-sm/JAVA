...
class Person {
	...
	// 멤버변수 name에 대한 Getter 메서드 정의
	// 파라미터 값은 없고, 리턴값은 있는 메서드
	...
	// 멤버변수 name에 대한 Setter 메서드 정의
	// 파라미터 값은 있고, 리턴값은 없는 메서드
...
//		name = name; // 로컬변수 name 값을 다시 로컬변수 name에 저장하는 코드
	...
	// 멤버변수 age에 대한 Getter 메서드 정의
	public int getAge() {
		return age;
	}
	// 멤버변수 age에 대한 Setter 메서드 정의
