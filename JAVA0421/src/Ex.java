...
public class Ex {
	...
	public static void main(String[] args) {
		...
		// 즉, 인스턴스 멤버변수인 a와 b는 인스턴스마다 생성되므로
		// 하나의 인스턴스에서 인스턴스 멤버변수의 값을 바꾸더라도
		// 다른 인스턴스 멤버변수에는 아무런 영향이 없다!!
		// => 생성된 메모리 공간이 다르기 때문
		
	    System.out.println("====================================");
		
	    // StaitcMember 클래스의 인스턴스 생성 전에 static 멤버 접근
	    System.out.println("StaticMember.a : " + StaticMember.a);
//	    System.out.println("StaticMember.a : " + StaticMember.b); // 오류 발생
	    // Cannot make a static reference to the non-static field StaticMember.b
	    // => 인스턴스가 생성되기 전이지만 이미 메모리에 등록되어 있으므로
