...
public class Ex5 {
	...
	public static void main(String[] args) {
		 ...
		 * - InputStream 객체를 파라미터로 갖는 InputStreamReader 객체를 생성한 후
		...
		// 1. 기본스트림 객체(InputStream) 생성 = byte 단위 처리
//		InputStream is = System.in;
		
		// 2. 입력스트림을 연결하는 보조스트림 InputStreamReader 객체 생성 = char 단위 처리
//		InputStreamReader reader = new InputStreamReader(is);
		
		// 3. 향샹된 입력 보조스트림 BufferReader 객체 생성 = String 단위 처리
...
//		}
		...
		// =================================================================================
		// 반복문을 사용하여 Ctrl + Z 입력 시 까지의 모든 문자열 출력
		// => 주의! Ctrl + 입력 데이터가 정수일 때는 -1, 문자열 일때는 null 값을 사용
