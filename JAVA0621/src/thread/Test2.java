 ...
 * 1. 싱글쓰레드로 구현
 * - class명 : SendMessage
 * - 멤버변수 : 메세지(msg, 문자열), 횟수(count, 정수형)
 * - 파라미터 생성자(String, int)
 * - run() 메서드 : 리턴값 없음, 파라미터 없음, count만큼 msg 출력
 *   ex) 메세지 전송 - 1 : 안녕하세요
 *       메세지 전송 - 2 : 안녕하세요
 */
class SendMessage {
 ...
 * 1. 싱글쓰레드로 구현
 * - class명 : FileTransfer
 * - 멤버변수 : 파일명(fileName, 문자열), 횟수(count, 정수형)
 * - 파라미터 생성자(String, int)
