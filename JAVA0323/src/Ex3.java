...
public class Ex3 {
	...
	public static void main(String[] args) {
		 ...
		 *   => 즉, 안쪽 for문의 반복 횟수가 바깥쪽 for문의 반복 횟수보다 많다.
		 ...
		 * 		문장1; // 바깥쪽 for문의 조건1이 true일 때 실행되는 문장
		 * 
		 ...
		 * 		}
		 * 
		 *  	문장3; // 안쪽 for문의 반복이 종료된 후 실행되는 문장	
		 * }
		 */
		...
		for(int i = 1; i <= 3; i++) { // 바깥쪽 for문
			...
			// 안쪽 for문 반복이 종료되면 실행되는 문장
			System.out.println("------- 안쪽 for문 반복 종료");
		}
		
		// 바깥쪽 for문 반복이 종료되면 실행되는 문장
