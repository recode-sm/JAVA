...
public class Test3 {
	...
	public static void main(String[] args) {
		...
		MyDate d3 = new MyDate(2000,1);
		System.out.println(d3.year + "/" + d3.month + "/" + d3.day);
		
		MyDate d4 = new MyDate(2000,1,1);
 ...
 * - 생성자
 *   1) 기본 생성자 : 2022년 4월 14일로 초기화
 *   2) 파라미터 생성자
 *      2-1. 연도(year)를 전달받아 초기화하고, 4월 14일로 초기화
 *      2-2. 연도(year), 월(month)을 전달받아 초기화하고, 14일로 초기화
