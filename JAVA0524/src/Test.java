...
public class Test {
	...
	public static void main(String[] args) {
		...
		// => 생성된 s3 와 s4 는 문자열 내용은 같지만, 주소값이 다르다.
		

		// 동등비교연산자를 사용한 두 문자열의 주소값 비교
		if(s3 == s4) {
			System.out.println("s3 와 s4 는 주소값이 같다!");
		} else {
			System.out.println("s3 와 s4 는 주소값이 다르다!");
		}
		
		// String 클래스의 오버라이딩 된 equlas() 메서드를 사용한
		// 두 문자열의 내용 비교
		if(s3.equals(s4)) {
			System.out.println("s3 와 s4 는 문자열 내용이 같다!");
		} else {
			System.out.println("s3 와 s4 는 문자열 내용이 다르다!");
		}
