...
public class Ex {
	...
	public static void main(String[] args) {
		 ...
		 * - Object 클래스의 모든 멤버는 다른 클래스에서 사용 또는 오버라이딩이 가능
		 * 
		...
		System.out.println("p2 의 객체 정보 : " + p2);
		...
		Person p3 = p2;
		System.out.println("p2 의 객체 정보 : " + p2);
		System.out.println("p3 의 객체 정보 : " + p3);
...
class OverridePerson {
	...
	// 하나라도 다를 경우 false를 리턴, 모두 같은 경우 true 리턴하도록 수정(재정의)
	@Override
