...
public class Ex {
	...
	public static void main(String[] args) {
		 ...
		 *   => System.out : 표준 출력을 담당(모니터로 출력 기능)
...
//			is = System.in;
//			// => System.in 코드에 의해 키보드로부터 데이터 입력이 가능해짐
...
//		}
		 ...
		 *   더 이상 다른 사용자의 작업 요청을 수행할 수 없게 됨!
		 *   => 예외 발생 여부와 관계없이 finally 블록 내에서 자원 반환 코드 기술
		 * - try with resources 구문은 try 문에서 반환할 자원을 갖는 객체를 생성하고
...
//		}
		...
		// ==================================================================================
		// 반복문을 사용하여 1Byte 씩 여러 번 반복하여 입력 처리
		System.out.println("데이터를 입력하세요 : (취소 시 Ctrl + Z)");
		
			try(InputStream is = System.in) {
				int n = is.read();
				
				// 반복문을 사용하여 더 이상 읽어 올 데이터가 없을때(-1) 까지 입력 처리
				while(n != -1) {
