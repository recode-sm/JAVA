...
public class Ex2 {
	...
	public static void main(String[] args) {
		...
		System.out.println("동생아! 불을 좀 끄고 가라!");
		sister_1(); // sister_1() 메서드 호출(sister_1() 메서드로 흐름이 이동)
		// => 매개변수(파라미터)가 없으므로 소괄호 안에 전달할 데이터도 없다!
...
//		sister_2();
		...
		// => sister_2() 메서드 호출 후 리턴값("물")을 전달받아
...
//		System.out.println("동생이 가져다 준 것 : " + sister_2());
	...
	*/ 
	...
	public static String sister_2() {
		...
		// return 문을 사용하여 리턴타입 String에 해당하는 데이터 리턴
