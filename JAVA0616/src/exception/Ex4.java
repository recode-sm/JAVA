...
//			throw e;
	...
	public static void userExceptionMothod(int score) throws InvalidScoreException {
		if(score < 0 || score > 100) {
			// Exception 클래스 대신 사용자 정의 예외 클래스 적용
...
// 사용자 정의 예외 클래스 작성
// - 원하는 이름의 서브클래스 정의 후 예외 클래스를 상속받음
// - 주로 Exception 클래스를 상속받아 정의함

class InvalidScoreException extends Exception {
	
	// 생성자를 정의하여 예외 메시지를 슈퍼클래스의 생성자에게 전달
