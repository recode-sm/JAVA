...
public class Ex3 {
	...
	public static void main(String[] args) {
		...
		try {
			...
			System.out.println("사장이 직접 모든 예외를 처리!");
		}
...
//		}
	...
	public static void 대리() throws RuntimeException , ClassNotFoundException  {
		// 사원1 의 예외를 위임받아 처리할 때
		// 1. 위임받은 대리가 직접 처리하는 경우
//		try {
//			사원();
//			사원2();
//		} catch(ArithmeticException e) {
//			System.out.println("대리가 사원의 ArithmeticException 예외 처리!");
//		} catch(NullPointerException e) {
//			System.out.println("대리가 사원의 NullPointerException 예외 처리!");
//		} catch(ClassNotFoundException e) {
//			System.out.println("대리가 사원의 ClassNotFoundException 예외 처리!");
//		}
...
//		}
		...
		// 예외 처리 방법 2. 메서드 호출한 곳으로 throws 키워드로 예외를 위임
		// => 현재 사원() 메서드를 호출한 곳(대리())으로 예외를 던짐(throws)
		// => 사원() 메서드 선언부 마지막에 throws 키워드를 쓰고
		//    throws 뒤에 예외 클래스 1개 또는 복수개 명시
