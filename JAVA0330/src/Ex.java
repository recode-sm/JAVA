...
//		score = 90; // 오류 발생 : Type mismatch: cannot convert from int to int[]
		//             => 배열 이름으로 사용되는 변수에 데이터 저장 불가!
...
//		System.out.println(score[5]); // 실행 시 오류 발생!
		...
		// at Ex.main(Ex.java:84)
		// ArrayIndexOutOfBoundsException: 5 => 5번 인덱스가 범위를 벗어남!
		// at Ex.main(Ex.java:84) => Ex.java 클래스의 84번 라인이 오류
...
//		System.out.println(score[4]); // score 배열의 4번 인덱스 데이터 값 출력
		...
		// => 배열의 크기값을 반복문의 조건식에 활요하면
		//    배열의 크기가 변경되어도 동적으로 대응 가능!
...
//			System.out.println(score[i]);
		...
		int arr3, arr4[]; // arr3 int형 변수, arr4 int[] 타입 변수로 선언됨
